...
/*   Updated: 2017/02/27 08:05:06 by ssmith           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ft_linecpy(char *str, char *buf, t_gnl **data, int type)
{
	int		i;
...
static char		*ft_buffsave(char *buf, int size)
{
	int		nbr;
	int		i;
	char	*buffsave;
...
static t_gnl	*find_buf(char ***str, t_gnl *data)
{
	if (!data)
	{
